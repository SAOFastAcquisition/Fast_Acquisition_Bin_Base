...
if __name__ == '__main__':
    ...
    n = 1024                 # Длина исходной последовательности
    m = 256                  # Порядок фильтра должен быть кратным коэффициенту интерполяции
    l_interpol = 4
    ...
    h, fft_h = ftr.synt_filter(512, 128, 256)    # Отклик прямоугольного модельного фильтра
    n_filter = len(h)
