...
def noise_self_calibration(_spectrum, _ngi_temperature_path):
    ...
    t_cal0, t_cal1 = 11, 19  # Интервал Импульса ГШ, сек
    t_ground1, t_ground2 = 21, 29  # Интервал определения фона, сек
    t_cal0r, t_cal1r = 11, 19  # Интервал Импульса ГШ, сек
...
if __name__ == '__main__':
    ...
    current_primary_dir = '2022_03_25sun'
    current_primary_file = '2022-03-25_06+08'
    ...
    freq_res = 10  # Установка разрешения по частоте в МГц
    kt = 12  # Установка разрешения по времени в единицах минимального разрешения 8.3886e-3 сек
    delta_t = 8.3886e-3
    delta_f = 7.8125
